...
public class MonthCalendarWidget extends AppWidgetProvider {
    private static final String ACTION_PREVIOUS_MONTH = "com.mobile_term_project.android.monthcalendarwidget.action.PREVIOUS_MONTH";
    private static final String ACTION_NEXT_MONTH = "com.mobile_term_project.android.monthcalendarwidget.action.NEXT_MONTH";
    private static final String ACTION_RESET_MONTH = "com.mobile_term_project.android.monthcalendarwidget.action.RESET_MONTH";
